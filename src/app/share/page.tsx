  ...
  const article = useMemo(() => {
    ...
    if (data) {
      try {
        ...
        console.error('Failed to decode article data');
        return null;
      }
    }
    return null;
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center">
        <div className="text-center bg-white rounded-2xl shadow-xl p-8 max-w-md">
          ...
          <p className="text-gray-500 mb-6">এই লিংকটি সঠিক নয় বা আর্টিকেল সরানো হয়েছে।</p>
          <Link 
            href="/"
      ...
      <main className="container mx-auto px-4 py-8">
        <article className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-6 md:p-10">
            {/* বিসমিল্লাহ */}
            <div className="text-center text-3xl mb-6 text-[#1B5E20]" style={{ fontFamily: 'Amiri, serif' }}>
